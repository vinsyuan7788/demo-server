package com.demo.spring.boot.web.application.springboot;
...
import com.demo.spring.boot.req.GetWithParametersReq;
import com.demo.spring.boot.req.PostWithParametersReq;
