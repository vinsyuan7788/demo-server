package com.demo.spring.boot.application.concurrent.forkjoin;

import com.demo.spring.boot.application.concurrent.forkjoin.task.CustomTaskWithNoReturn;
import com.demo.spring.boot.application.concurrent.forkjoin.task.CustomTaskWithReturn;
